...
The last command prints "DONE  Packaged: C:\workspace\DeepTest\deeptest-0.3.6.vsix".
...
`C:\workspace\DeepTest\deeptest-0.3.6.vsix`, and click "Install". A
...
by the build number, for example "DeepTest 0.3.6". Repeat these steps after every change to the
